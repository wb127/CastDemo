...
package com.philips.castdemo.videobrowser.mediaplayer;
...
import com.philips.castdemo.videobrowser.CastApplication;
import com.philips.castdemo.videobrowser.R;
import com.philips.castdemo.videobrowser.settings.CastPreference;
import com.philips.castdemo.videobrowser.utils.Utils;
...
public class LocalPlayerActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (null != b) {
            ...
            mStreamType = b.getInt("streamType");
            ...
            case PLAYING:
                ...
                if(mStreamType == MediaInfo.STREAM_TYPE_LIVE)
                {
                    mPlayPause.setImageDrawable(
                            getResources().getDrawable(R.drawable.ic_av_stop_dark));
                }
                else {
                    mPlayPause.setImageDrawable(
